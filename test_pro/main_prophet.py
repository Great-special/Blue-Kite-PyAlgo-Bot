...
def start_bot():
    ...
    for i in TRADEABLE:
        ...
        if mode == "live":
            ...
            combined_forecast, slope = combine_forecast(prophet_forecast, garch_forecast, data, mode=mode)
            ...
            combined_forecast, slope = combine_forecast(prophet_forecast, garch_forecast, data)
